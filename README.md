...
2. Navigate to the directory where you saved the repo and open the R script **run_analysis.R** with your favorite R client (RStudio recommended). **Please also ensure that the source data files are in the folder "./SourceData/UCI HAR Dataset" before you run the run_analysis.R script**
